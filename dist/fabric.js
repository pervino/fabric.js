/* build: `node build.js modules=text,itext,textbox,serialization,interaction,animation,gestures,shadows,object_straightening no-svg-export minifier=uglifyjs` */
